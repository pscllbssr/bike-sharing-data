...
For each trip we add the haversine distance between the two stations. Of course following a straight line on a bike trip in a city is not possible, as there are many buildings and other obstacles. But at least it is an approximation of how far the stations are apart.  
