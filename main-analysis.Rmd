...
# count the number of trips taht lasted 2 minutes or less and starting and ending at the same station
...
To narrow our analysis furthermore, we will only consider the data coming from the top 20 stations in each city.

```{r top_20, results = FALSE}
...
# Sort the data by city and num_trips, and keep only the top 20 stations for each city
