...
All chosen predictor variables have a significant impact on the duration of the trips. The R^2 is of `r w round(summary(model_lm2)$r.squared,2)` and RMSE is `r round(sqrt(mean(model_lm2$residuals^2)),2)`.
...
We also wanted to see if we could get a better estimation of the trip duration with a neural network. In order to do this, we first scaled our dataset and then splitted in a test- and train-part. Round trips have been excluded from this analysis.
